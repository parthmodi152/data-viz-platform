  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#161618]">
      <Card className="w-[400px] bg-[#242424] border-[#5A5A5A] text-white">
        <CardHeader>
          <CardTitle className="text-[32px] font-bold text-green-2 text-center">Create Account</CardTitle>
          <CardDescription className="text-gray-300 text-center">Sign up for a new account</CardDescription>
        </CardHeader>
        <CardContent>
          <Button 
        ...
        <CardFooter className="flex flex-col space-y-2">
          <div className="text-sm text-center text-gray-400">
            ...
            <Link to="/login" className="text-green-2 hover:underline">
              Sign in
            </Link>
          </div>
        </CardFooter>
